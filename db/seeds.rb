...
User.create!(email: 'user1@user.com', first_name: "Namey", last_name: "McNameface", password: "password", role: :default, iud:"40919519")
User.create!(email: 'user2@user.com', first_name: "Namey_2", last_name: "McNameface", password: "password", role: :default, iud:"42525195")
User.create!(email: 'user3@user.com', first_name: "Namey_3", last_name: "McNameface", password: "password", role: :default, iud:"41347275")